...
const styles = {
  page: {
    ...
    background:
      'linear-gradient(180deg, #F7FAFC 0%, #F4F5F8 38%, #EEF1F5 100%)',
    padding: '24px',
    display: 'flex',
  ...
  header: {
    ...
    borderRadius: '24px',
    background:
      'linear-gradient(135deg, rgba(14, 116, 144, 0.98) 0%, rgba(15, 23, 42, 0.96) 100%)',
    color: '#FFFFFF',
  ...
  tabButtonActive: {
    background:
      'linear-gradient(135deg, rgba(14, 165, 233, 0.12) 0%, rgba(14, 116, 144, 0.16) 100%)',
